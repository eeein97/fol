...
<div>
	...
	<form class="notice" method="post" action="/notice/register">
		...
		<table>
			...
			<tr>
				<td>작성자</td>
				<td><input type="text" name="writer" value="<sec:authentication property="principal.username"/>" readonly required /></td>
			</tr>
			<tr>
				<td>내용</td>
